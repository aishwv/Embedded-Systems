...
1966425
12/04/2022
This is a header file for Lab4Task1c_Inits and Lab4_Task1c that contains pointers to 
registers that are frequently used in the main program to set up and use the ADC and
GPIO
*/
