...
1966425
11/29/2022
This program contains initialization functions that set up the modules used in 
the main program 
*/
...
void Switch_Init(void) {
  // STEP 1: Initialize the 2 on board switches by initializing the corresponding
  // GPIO pins.
